...
def test_oauth_start_connects_in_internal_mode_without_provider_env():
    client = make_client()
...
def test_direct_evidence_upload_creates_source_and_records():
    client = make_client()
    csv_body = "timestamp,field,block,crop,flow_gpm,duration_minutes,water_gallons,note\n2026-06-26 06:00:00,North Ranch,Block A,Almonds,420,45,18900,ok\n"
    response = client.post(
