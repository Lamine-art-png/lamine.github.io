...
HEAD_ALEMBIC_REVISION = "033_intelligence_wallet_commerce"
...
HEAD_SCHEMA_REQUIREMENTS: dict[str, set[str]] = {
    ...
    "field_capture_sessions": {"id", "tenant_id", "workspace_id", "user_id", "client_capture_id", "idempotency_key", "status", "asset_manifest_json", "metadata_json"},
    "field_observations": {"id", "tenant_id", "workspace_id", "capture_session_id", "status", "structured_json", "confidence", "provenance_json"},
    "field_observation_assets": {"id", "tenant_id", "capture_session_id", "client_asset_id", "object_ref", "content_sha256", "status"},
    "field_observation_processing_runs": {"id", "tenant_id", "capture_session_id", "stage", "status", "attempt_count"},
    ...
    "platform_request_logs": {"id", "organization_id", "api_project_id", "request_id", "client_correlation_id", "operation_id"},
