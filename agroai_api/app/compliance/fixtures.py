...
VINEYARD_FIXTURE = {
    ...
    "parcels": [
        {"id": "parcel-sv-101", "organization_id": ORG_ID, "parcel_identifier": "US-CA-SON-123-456-010", "apn": "123-456-010", "geometry_ref": "s3://agroai-evidence/sv/parcel-101.geojson", "county": "Sonoma", "place_of_use": "Block A North vineyard"},
        {"id": "parcel-sv-102", "organization_id": ORG_ID, "parcel_identifier": "US-CA-SON-123-456-011", "apn": "123-456-011", "geometry_ref": "s3://agroai-evidence/sv/parcel-102.geojson", "county": "Sonoma", "place_of_use": "Block B South vineyard"},
    ],
    "wells": [
