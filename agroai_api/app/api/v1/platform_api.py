...
def platform_openapi() -> dict[str, Any]:
    ...
    paths: dict[str, Any] = {}
    standard_headers = {
        "X-Request-Id": {"description": "Server-generated request identifier. A supplied request value is retained only as bounded client correlation metadata.", "schema": {"type": "string"}},
            ...
            "parameters": [
                {
                    ...
                    "in": "header",
                    "required": False,
                    "description": "Optional client correlation identifier. The response X-Request-Id is independently generated by the server.",
