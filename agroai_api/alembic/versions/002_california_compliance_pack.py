...
def upgrade():
    ...
    _create_table_if_missing("compliance_parcels", sa.Column("id", sa.String(), primary_key=True), sa.Column("tenant_id", sa.String(), sa.ForeignKey("tenants.id"), nullable=False), sa.Column("parcel_identifier", sa.String(), nullable=False), sa.Column("apn", sa.String(), nullable=True), sa.Column("geometry_ref", sa.Text()), sa.Column("geometry", sa.JSON()), sa.Column("county", sa.String()), sa.UniqueConstraint("tenant_id", "parcel_identifier", name="uq_compliance_parcel_tenant_identifier"))
    ...
    for table, columns in {
        ...
        "compliance_parcels": ["tenant_id", "parcel_identifier"],
