...
6. Generate versioned proof packages for reviewer evaluation. Each snapshot includes its status, rule-pack versions, evidence references, checksum, and disclaimer.
