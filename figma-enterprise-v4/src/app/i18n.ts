...
const en: Record<string, string> = {
  ...
  "intelligence.preparingAnswer": "Preparing the answer...", "intelligence.preparingPdf": "Preparing PDF...", "intelligence.downloadPdf": "Download PDF", "intelligence.previewArtifact": "Preview",
...
const frFR: Record<string, string> = {
  ...
  "intelligence.preparingAnswer": "Préparation de la réponse...", "intelligence.preparingPdf": "Préparation du PDF...", "intelligence.downloadPdf": "Télécharger le PDF", "intelligence.previewArtifact": "Aperçu",
...
const pt: Record<string, string> = {
  ...
  "app.loadingPortal": "Carregando portal",
  language: "Idioma", save: "Salvar", saved: "Salvo", saving: "Salvando...", send: "Enviar", sending: "Enviando...",
  retry: "Tentar novamente", remove: "Remover", ready: "Pronto", done: "Concluído", working: "Processando...",
  newOperation: "Nova operação", fieldOperatingRoom: "Sala de operações de campo", workspace: "Espaço de trabalho", operate: "Operações",
  intelligence: "Inteligência", account: "Conta", commandCenter: "Centro de Comando", fieldQueue: "Fila de Campo",
  fieldIntelligence: "Inteligência de Campo", tasks: "Tarefas", decisions: "Decisões", evidence: "Evidências",
  reports: "Relatórios", connectors: "Conectores", askAgroAi: "Pergunte ao AGRO-AI", readiness: "Prontidão",
  exceptions: "Exceções", sources: "Fontes", team: "Equipe", settings: "Configurações", profile: "Perfil",
  billing: "Faturamento", security: "Segurança", support: "Suporte", requests: "Solicitações", admin: "Administração",
  systemHealth: "Saúde do Sistema", logout: "Sair", plan: "Plano",
  settingsTitle: "Configurações",
  settingsSubtitle: "Edite o idioma, a conta, as preferências do espaço de trabalho, as notificações, a assinatura, as integrações e a segurança operacional em um só lugar.",
  languageRegion: "Idioma e região",
  languageRegionHint: "Escolha o idioma do portal. O AGRO-AI também usa essa preferência ao responder.",
  ...
  "intelligence.title": "Pergunte ao AGRO-AI",
  "intelligence.newChat": "Nova conversa",
  "intelligence.history": "Histórico",
  "intelligence.search": "Buscar conversas",
  "intelligence.closeSidebar": "Fechar barra lateral",
  "intelligence.deleteChat": "Excluir conversa",
  "intelligence.workspaceBadge": "Inteligência do espaço de trabalho",
  "intelligence.subtitle": "Faça perguntas, importe arquivos, gere relatórios, crie tarefas de campo, registre atualizações e prepare operações sujeitas a aprovação.",
  "intelligence.placeholder": "Pergunte ao AGRO-AI ou importe arquivos",
  "intelligence.importFiles": "Importar arquivos",
  "intelligence.loadingChats": "Carregando conversas...",
  "intelligence.noChats": "Nenhuma conversa salva ainda.",
  "intelligence.enterHint": "Enter para enviar. Shift + Enter para uma nova linha.",
  "intelligence.emptyTitle": "Em que devemos trabalhar?",
  "intelligence.emptyBody": "Comece por um talhão, relatório, requisito de conformidade, conta de cliente, decisão de irrigação, lacuna de evidência ou conjunto de dados desorganizado.",
  "intelligence.unavailable": "O AGRO-AI não conseguiu concluir a solicitação.",
  "intelligence.retryState": "O AGRO-AI não conseguiu concluir esta resposta. Tente novamente.",
  "intelligence.languageGenerationFailed": "O AGRO-AI gerou a resposta no idioma errado e não conseguiu corrigi-la com segurança. Sua mensagem foi preservada. Tente novamente.",
  "intelligence.startThread": "Iniciar uma conversa no espaço de trabalho",
  "intelligence.askOrImport": "Faça uma pergunta ou importe arquivos.",
  "intelligence.liveEvidenceBody": "O AGRO-AI usa inferência de modelo em tempo real, o histórico da conversa e as evidências disponíveis no espaço de trabalho para responder exatamente ao que você perguntou.",
  "intelligence.prompt.data": "O que devo fazer com meus dados?",
  "intelligence.prompt.checklist": "Criar um checklist para o operador.",
  "intelligence.prompt.missingEvidence": "Quais evidências estão faltando?",
  "intelligence.prompt.report": "Gerar um relatório pronto para o cliente.",
  "intelligence.preparingAnswer": "Preparando a resposta...",
  "intelligence.preparingPdf": "Preparando PDF...",
  "intelligence.downloadPdf": "Baixar PDF",
  "intelligence.previewArtifact": "Pré-visualizar",
  "intelligence.emailToMe": "Enviar por e-mail para mim",
  "intelligence.emailing": "Enviando...",
  "intelligence.summarizeImportedFiles": "Resuma os arquivos que importei.",
  "intelligence.importFailed": "Falha na importação",
  "intelligence.fileQueued": "Na fila",
  "intelligence.fileUploading": "Enviando...",
  "intelligence.fileImported": "Importado",
  "intelligence.fileFailed": "Falhou",
  "intelligence.fileFailedBeforeSend": "Um arquivo não foi importado. Remova-o antes de enviar.",
  "intelligence.pdfExportFailed": "O AGRO-AI não conseguiu exportar o relatório em PDF.",
  "intelligence.pdfEmailFailed": "O AGRO-AI não conseguiu enviar o relatório em PDF por e-mail.",
  "intelligence.actionCompleted": "Ação concluída: {title}",
  "intelligence.actionExecuteFailed": "O AGRO-AI não conseguiu executar esta ação.",
  "intelligence.approvalRequired": "Aprovação necessária",
  "intelligence.riskReady": "Pronto",
  "intelligence.riskLabel": "Risco {level}",
  "intelligence.createApproval": "Criar aprovação",
