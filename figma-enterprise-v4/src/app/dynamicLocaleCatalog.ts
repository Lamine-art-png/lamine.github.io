...
// Keep browser translation units small enough for the edge fast path to finish
// inside one bounded provider request in the common case. Translation hydration
// must never create a request herd against the customer API.
const REQUEST_CHUNK_MAX_KEYS = 36;
const REQUEST_CHUNK_MAX_CHARS = 1_600;
const REQUEST_PARALLELISM = 2;
const MAX_HYDRATION_PASSES = 2;
const MAX_CHUNK_ATTEMPTS = 1;
