...
const COPY = [
  ...
  "Market price change",
  "Yield change",
  "FX quote change (reporting currency per source currency)",
        ...
        <div className="mt-6 grid gap-6 xl:grid-cols-2">
          <section className="rounded-3xl border p-5 sm:p-6" style={{ background: "#FFFDF8", borderColor: "#D6DDD0" }}>
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-2">
              ...
              <ScenarioField label={tx("FX quote change (reporting currency per source currency)")} value={assumptions.fx_pct} onChange={(value) => setAssumptions((state) => ({ ...state, fx_pct: value }))} suffix="%" />
