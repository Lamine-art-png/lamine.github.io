    ...
    <div className="min-h-screen">
      <header className="bg-[#FFFEFA] border-b border-[rgba(16,35,27,0.12)] px-8 py-5">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-6">
            <h1 className="text-2xl font-bold text-[#10231B]">Sources</h1>
      ...
      <div className="p-8">
        <div className="bg-[#FFFEFA] border border-[rgba(16,35,27,0.12)] rounded-xl p-8">
          <h2 className="text-lg font-bold text-[#10231B] mb-4">Data Sources</h2>
          <p className="text-[#68776F]">
            Manage connected data sources and telemetry feeds.
          </p>
        </div>
      </div>
    </div>
