...
const FALLBACK_PLANS: Plan[] = [
  { id: "free", name: "Free", public_price_monthly: "$0/month", public_price_annual: "$0/year", recommended_buyer: "For pilots and small teams testing AGRO-AI.", included_limits: { users: "1 user", workspaces: "1 workspace", uploads: "10 evidence uploads/month" }, features: ["Basic field updates", "Basic readiness view", "Basic support request"] },
  { id: "professional", name: "Professional", public_price_monthly: "$299/month", public_price_annual: "$2,990/year", recommended_buyer: "For commercial farms, advisors, and operators running field operations.", included_limits: { users: "3 seats included", workspaces: "5 workspaces", uploads: "500 evidence uploads/month" }, features: ["Water risk briefs", "Operator checklists", "Report and PDF generation", "Compliance packet drafts", "Standard support"], annual_savings_badge: "Save 17% annually" },
  { id: "team", name: "Team", public_price_monthly: "$799/month", public_price_annual: "$7,990/year", recommended_buyer: "For advisory teams, farm management teams, and multi-site operators.", included_limits: { users: "10 seats included", workspaces: "25 workspaces", uploads: "2,500 evidence uploads/month" }, features: ["Team member invites", "Role controls", "Shared evidence library", "Admin request inbox", "Connector workflows"], annual_savings_badge: "Most popular" },
  { id: "network", name: "Network", public_price_monthly: "$1,500/month", public_price_annual: "$15,000/year", recommended_buyer: "For grower networks, water districts, exporters, lenders, insurers, and multi-farm programs.", included_limits: { users: "25 seats included", workspaces: "50 workspaces or sites", acres: "50,000 managed acres included" }, features: ["Network dashboard", "Multi-workspace reporting", "Compliance and evidence rollups", "Partner reporting", "Priority onboarding"] },
  { id: "enterprise", name: "Enterprise", public_price_monthly: "Contact sales", public_price_annual: "Contact sales", recommended_buyer: "For agencies, lenders, insurers, food companies, and national-scale networks.", included_limits: { users: "Custom seats", workspaces: "Custom workspaces", uploads: "Custom upload volume" }, features: ["SSO/SAML planning", "Audit logs", "Custom integrations", "Dedicated onboarding", "Security review"], is_custom_pricing: true },
];
...
const COMPARISON = [
  ...
  ["Evidence uploads", "10/mo", "500/mo", "2,500/mo", "10,000/mo", "Custom"],
  ["Connectors", "Locked", "Standard", "Standard", "Advanced", "Custom"],
...
const REQUIRED_PLAN_COPY: Record<string, string> = {
  professional: "This feature is included in Professional and above. Upgrade to unlock reports, connectors, compliance drafts, and commercial workspace limits.",
  team: "This feature is included in Team and above. Upgrade to unlock team invites, role controls, shared evidence, and the admin request inbox.",
  network: "This feature is included in Network and above. Upgrade when you need multi-workspace rollups, program dashboards, and network reporting.",
  enterprise: "This feature requires an Enterprise rollout. Contact sales for custom security, SSO, integrations, and governance review.",
};
