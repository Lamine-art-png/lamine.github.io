...
export function MonetizedRequestsV2() {
  ...
  function openWall() {
    openCommercialBoundary({
      ...
      conversion_context: "Team gives operators one tracked request inbox for support, onboarding, integrations, upgrades, ownership, and follow-through. Stay below Team and important requests remain scattered across email and ad hoc follow-ups, making delays, duplicate work, and missed handoffs much more likely.",
      source: "requests",
    });
  }
