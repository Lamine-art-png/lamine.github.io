...
export function MonetizedTeamV2() {
  ...
  function openWall() {
    openCommercialBoundary({
      ...
      conversion_context: "Team turns individual AGRO-AI work into coordinated operations with direct invitations, role controls, shared evidence, and approvals. Stay below Team and collaboration keeps spilling into inboxes, side chats, duplicate files, and manual follow-up—exactly where decisions get delayed or lost.",
      source: "team",
    });
  }
