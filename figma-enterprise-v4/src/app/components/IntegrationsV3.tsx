...
const PROFILES: Record<string, Profile> = {
  ...
  whatsapp: { title: "WhatsApp Field Intelligence", subtitle: "Voice, photos, location & field updates", type: "account", description: "Turn the channel field teams already use into governed AGRO-AI observations, processing jobs, evidence, assignments, and verified closure.", authPattern: "provider_api", action: "Configure WhatsApp", logoUrl: "https://www.google.com/s2/favicons?domain=whatsapp.com&sz=128", logoFallback: "WA", logoBg: "#ECFDF5", logoColor: "#128C7E" },
