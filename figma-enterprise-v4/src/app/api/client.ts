...
export const apiClient = {
  ...
  platformDeveloper: {
    ...
    updateProject: (projectId: string, payload: unknown) => patch(`/v1/platform/developer/projects/${encodeURIComponent(projectId)}`, payload),
    serviceAccounts: (projectId?: string) => get(`/v1/platform/developer/service-accounts${projectId ? `?project_id=${encodeURIComponent(projectId)}` : ""}`),
    ...
    updateServiceAccount: (serviceAccountId: string, payload: unknown) => patch(`/v1/platform/developer/service-accounts/${encodeURIComponent(serviceAccountId)}`, payload),
    keys: (serviceAccountId?: string) => get(`/v1/platform/developer/keys${serviceAccountId ? `?service_account_id=${encodeURIComponent(serviceAccountId)}` : ""}`),
    ...
    revokeKey: (keyId: string) => post(`/v1/platform/developer/keys/${encodeURIComponent(keyId)}/revoke`),
    rotateKey: (keyId: string, overlapMinutes = 60) => post(`/v1/platform/developer/keys/${encodeURIComponent(keyId)}/rotate`, { overlap_minutes: overlapMinutes }),
    usage: () => get("/v1/platform/developer/usage"),
    requestLogs: (projectId?: string) => get(`/v1/platform/developer/request-logs${projectId ? `?project_id=${encodeURIComponent(projectId)}` : ""}`),
    webhooks: () => get("/v1/platform/developer/webhooks"),
    createWebhook: (payload: unknown) => post("/v1/platform/developer/webhooks", payload),
    rotateWebhookSecret: (endpointId: string, overlapMinutes = 60) => post(`/v1/platform/developer/webhooks/${encodeURIComponent(endpointId)}/secret/rotate`, { overlap_minutes: overlapMinutes }),
    disableWebhook: (endpointId: string) => post(`/v1/platform/developer/webhooks/${encodeURIComponent(endpointId)}/disable`),
    webhookDeliveries: (endpointId: string) => get(`/v1/platform/developer/webhooks/${encodeURIComponent(endpointId)}/deliveries`),
    billing: () => get("/v1/platform/developer/billing"),
    liveAccess: () => get("/v1/platform/live-access"),
  ...
  platformProductAdmin: {
    applications: (status?: string, applicationType?: string) => {
      ...
      if (applicationType) query.set("application_type", applicationType);
      return get(`/v1/platform/admin/applications${query.toString() ? `?${query.toString()}` : ""}`);
    },
    reviewApplication: (applicationId: string, payload: unknown) => post(`/v1/platform/admin/applications/${encodeURIComponent(applicationId)}/review`, payload),
    applicationAudit: (applicationId: string) => get(`/v1/platform/admin/applications/${encodeURIComponent(applicationId)}/audit`),
    enrollments: (status?: string) => get(`/v1/platform/admin/enrollments${status ? `?status=${encodeURIComponent(status)}` : ""}`),
    suspendEnrollment: (enrollmentId: string, reason: string) => post(`/v1/platform/admin/enrollments/${encodeURIComponent(enrollmentId)}/suspend`, { reason }),
    liveAccess: (status?: string) => get(`/v1/platform/admin/live-access${status ? `?status=${encodeURIComponent(status)}` : ""}`),
    reviewLiveAccess: (requestId: string, payload: unknown) => post(`/v1/platform/admin/live-access/${encodeURIComponent(requestId)}/review`, payload),
    partnerDossiers: (providerId?: string) => get(`/v1/platform/admin/partner-dossiers${providerId ? `?provider_id=${encodeURIComponent(providerId)}` : ""}`),
    support: (status?: string) => get(`/v1/platform/admin/support${status ? `?status=${encodeURIComponent(status)}` : ""}`),
    updateSupport: (supportId: string, payload: unknown) => patch(`/v1/platform/admin/support/${encodeURIComponent(supportId)}`, payload),
    abuse: (status?: string) => get(`/v1/platform/admin/abuse${status ? `?status=${encodeURIComponent(status)}` : ""}`),
    reviewAbuse: (eventId: string, payload: unknown) => post(`/v1/platform/admin/abuse/${encodeURIComponent(eventId)}/review`, payload),
  ...
  assurance: {
    overview: (workspaceId: string) => get(`/v1/workspaces/${encodeURIComponent(workspaceId)}/assurance/overview`),
    rulePacks: (workspaceId: string) => get(`/v1/workspaces/${encodeURIComponent(workspaceId)}/assurance/rule-packs`),
    passports: (workspaceId: string) => get(`/v1/workspaces/${encodeURIComponent(workspaceId)}/assurance/passports`),
    createPassport: (workspaceId: string, payload: unknown) => post(`/v1/workspaces/${encodeURIComponent(workspaceId)}/assurance/passports`, payload),
    passport: (workspaceId: string, passportId: string) => get(`/v1/workspaces/${encodeURIComponent(workspaceId)}/assurance/passports/${encodeURIComponent(passportId)}`),
    readiness: (workspaceId: string, passportId: string) => get(`/v1/workspaces/${encodeURIComponent(workspaceId)}/assurance/passports/${encodeURIComponent(passportId)}/readiness`),
    evidenceCandidates: (workspaceId: string) => get(`/v1/workspaces/${encodeURIComponent(workspaceId)}/assurance/evidence-candidates`),
    mapEvidence: (workspaceId: string, passportId: string, payload: unknown) => post(`/v1/workspaces/${encodeURIComponent(workspaceId)}/assurance/passports/${encodeURIComponent(passportId)}/evidence-mappings`, payload),
    reviewQueue: (workspaceId: string, passportId: string) => get(`/v1/workspaces/${encodeURIComponent(workspaceId)}/assurance/passports/${encodeURIComponent(passportId)}/review-queue`),
    review: (workspaceId: string, passportId: string, payload: unknown) => post(`/v1/workspaces/${encodeURIComponent(workspaceId)}/assurance/passports/${encodeURIComponent(passportId)}/reviews`, payload),
    packages: (workspaceId: string, passportId: string) => get(`/v1/workspaces/${encodeURIComponent(workspaceId)}/assurance/passports/${encodeURIComponent(passportId)}/packages`),
