...
1. **Open the portal** at `https://app.agroai-pilot.com`.
   - Position AGRO-AI as the Water Command Center: quantitative recommendation, execution, and verification for connected irrigation environments.
2. **Launch the demo workspace** with **Launch AGRO-AI Demo Workspace**.
   - Explain that demo data is isolated and clearly labeled.
3. **Select a scenario** on Command Center.
...
4. **Generate a recommendation**.
   ...
   - Show the quantitative water decision, duration, depth, start time, ETo, root-zone deficit, confidence, data quality, key drivers, execution task, and verification requirement.
5. **Schedule irrigation**.
   - Click **Schedule recommendation** and show the Scheduled step update.
6. **Confirm applied water**.
   - Click **Mark as applied** and show the Applied step update with evidence.
7. **Add field observation**.
...
10. **Show live WiseConn recommendation**.
...
2. Select a scenario.
3. Show the quantitative recommendation artifact: **Irrigate 42 min tonight · start 21:00 PT**, **12 mm net**, **86% confidence**, and **Verified telemetry**.
4. Click through schedule, applied, observation, and verification.
5. Open the report preview.
6. Show Integrations and explain WiseConn/Talgil runtime status and backend credential requirements.
