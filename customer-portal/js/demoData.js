    ...
    zones: [
      {
        ...
        confidence: "86%",
        recommendation: "Irrigate 42 min tonight · start 21:00 PT",
        recommendationHeadline: "Irrigate 42 min tonight · start 21:00 PT",
        recommendationSubline: "12 mm net across Block A North · responding to ETo 6.4 mm and 38% deficit at 30 cm.",
        depthMm: 12,
        durationMin: 42,
        startTimeLocal: "21:00 PT",
        etoMm: 6.4,
        deficit30cm: "38%",
        confidenceScore: 86,
...
export const demoRecommendation = {
  ...
  dataQuality: "Verified telemetry",
  dataQualityLabel: "Verified telemetry",
  keyDrivers: ["ETo 6.4 mm increased crop water demand", "38% deficit at 30 cm in Block A North", "No meaningful rain expected before the evening window", "WiseConn controller window is available at 21:00 PT"],
  ...
  executionTask: "Schedule Block A North for 42 min at 21:00 PT through the WiseConn controller window.",
  verificationPlan: "Verify 12 mm net applied water against the controller event, then request field observation within 12 hours.",
};
