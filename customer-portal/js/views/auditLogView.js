...
export function renderAuditLog(state) {
  ...
  return `<div class="screen-stack"><section class="panel-card"><div class="section-heading"><p class="eyebrow">Audit Log</p><h2>Operational evidence trail</h2></div>${table(
